...
- **SDK is pinned to the public SDK repository.** `package.json` pins `@monolythium/core-sdk` to the v0.1.19 testnet SDK commit in [`monolythium/mono-core-sdk`](https://github.com/monolythium/mono-core-sdk). `pnpm install` resolves it from GitHub; no sibling checkout is required.
