...
export const DESIGN_SOURCE_AUDIT = [
  ...
  },
  {
    ...
    routes: ["/cluster"],
    operationKinds: ["cluster-form", "cluster-request-join", "cluster-vote-admit", "cluster-accept-invite", "cluster-swap"],
    runtimePrereq: "CJ-1 runtime for request/vote execution and a formation primitive for new clusters.",
    evidence: "Cluster route reads cluster status, provider directory, diversity, resignations, and cluster request/vote/form prep operations.",
    decision: "Browse and fail-closed request/vote/form prep exist; live admit and formation loops wait for runtime support.",
  },
  {
    file: "data.jsx",
    domain: "shared-data",
  ...
  },
  {
    ...
    runtimePrereq: "CJ-1 runtime and form-cluster chain semantics.",
    evidence: "Setup cluster route, CJ-1 request/vote prep, and 7 active + 3 standby roster prep are present.",
    decision: "Form-cluster execution remains blocked until a runtime primitive and SDK submit helper exist.",
  },
  {
