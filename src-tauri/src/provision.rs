...
pub const MONARCH_OS_INSTALLER_IMAGE: &str =
    "ghcr.io/monolythium/monarch-os-installer:v0.4.0-testnet";
...
across act action actor actress",
    ...
    fn evaluate_installer_pin_matches_registry() {
        let toml = "release_tag = \"v0.4.0-testnet\"\n";
        ...
        assert_eq!(check.pinned_tag, "v0.4.0-testnet");
        assert_eq!(check.registry_release_tag, "v0.4.0-testnet");
    }
