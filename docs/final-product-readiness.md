...
1. Keep GUI/Tauri e2e release validation supplied with current live peer chat, cluster, and mnemonic inputs for each candidate.
2. Replace remaining named blockers as mono-core/SDK endpoints become available.
